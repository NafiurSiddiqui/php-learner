...
//USE INTERFACE WHEN YOU ARE IMPLEMENTING TOO MANY ABSTRACT CLASSES
//THE SIGNATURE OF THE MEHTODS MUST BE IDENTICAL
//BUT YOU CAN USE ARGUMENTS IN THE CHILD WITH A DEFAULT VALUE
//Child classes must implement the methods from the INTERFACE
//you can not call properties but can use const
//you can not override const from the child
//METHODS MUST BE PUBLIC

interface DisplayItem
{
    public function showItem(string $text = null):string;
...
class HavanaCart implements DisplayItem
{

    public function showItem(?string $text = null): string
    {
        if($text !== null) {
            return "HavanaCart has $text";
        } else {
            return "HavanaCart does not have $text";
        }

    }
}

$havanaCart = new HavanaCart();

echo $havanaCart->showItem('Cuppa');
